...
// Note: increased default timeout to 120s — my NAS takes a while to wake from
// deep sleep, especially after a power outage. 90s was occasionally not enough.
